...
const RideDetails = () => {
  ...
  const pickupPoint = useMemo(() => textToGeoPoint(pickup, 3), [pickup]);
  const destinationPoint = useMemo(
    () => textToGeoPoint(destination, 5),
    [destination]
  );
    ...
    <motion.div
      ...
      <div className="p-4 space-y-5">
        ...
        <motion.div
          ...
          <span className="bg-slate-100 dark:bg-slate-700 text-xs font-bold px-2 py-1 rounded-lg text-slate-600 dark:text-slate-300">
            {driver.vehicleType}
          </span>
        </motion.div>
